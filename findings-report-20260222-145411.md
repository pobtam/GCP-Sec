...
Generated: 2026-02-22 22:54:11 UTC
...
**Summary**: Remediate SERVICE_AGENT_GRANTED_BASIC_ROLE finding on wanaware-game-dev

**Next Steps**:
- 1. Review the 'Security insights' column in [IAM](https://console.cloud.google.com/iam-admin/iam?project=150060933135) to understand identity security risk along with our recommendations to remediate it.
- 2. Or, if you have integrated your ITSM tool, a ticket is auto-created for findings with critical or high severity. Leverage the ticket ID to remediate this finding at a future time.
...
**Summary**: Remediate SERVICE_AGENT_GRANTED_BASIC_ROLE finding on wa-gcp-test

**Next Steps**:
- 1. Review the 'Security insights' column in [IAM](https://console.cloud.google.com/iam-admin/iam?project=885453410960) to understand identity security risk along with our recommendations to remediate it.
- 2. Or, if you have integrated your ITSM tool, a ticket is auto-created for findings with critical or high severity. Leverage the ticket ID to remediate this finding at a future time.
**Estimated Effort**: Medium-High (2 hours - 2 days)
**Automation Potential**: Medium
```bash
...
**Summary**: Review and restrict IAM permissions to least privilege

**Next Steps**:
- 1. Review the 'Security insights' column in [IAM](https://console.cloud.google.com/iam-admin/iam?project=503291607878) to understand identity security risk along with our recommendations to remediate it.
- 2. Or, if you have integrated your ITSM tool, a ticket is auto-created for findings with critical or high severity. Leverage the ticket ID to remediate this finding at a future time.
**Estimated Effort**: Medium (2-4 hours) — requires IAM policy review and update
**Automation Potential**: Medium
```bash
Refer to GCP documentation for CLI/Terraform automation options
```
...
**Next Steps**:
- 1. Review the 'Security insights' column in [IAM](https://console.cloud.google.com/iam-admin/iam?project=940510641271) to understand identity security risk along with our recommendations to remediate it.
- 2. Or, if you have integrated your ITSM tool, a ticket is auto-created for findings with critical or high severity. Leverage the ticket ID to remediate this finding at a future time.
**Estimated Effort**: Medium (2-4 hours) — requires IAM policy review and update
**Automation Potential**: Medium
```bash
...
**Summary**: Remediate SERVICE_AGENT_GRANTED_BASIC_ROLE finding on wanaware-prod

**Next Steps**:
- 1. Review the 'Security insights' column in [IAM](https://console.cloud.google.com/iam-admin/iam?project=1095920349335) to understand identity security risk along with our recommendations to remediate it.
- 2. Or, if you have integrated your ITSM tool, a ticket is auto-created for findings with critical or high severity. Leverage the ticket ID to remediate this finding at a future time.
**Estimated Effort**: Medium-High (2 hours - 2 days)
**Automation Potential**: Medium
```bash
...
**Next Steps**:
- 1. Review the 'Security insights' column in [IAM](https://console.cloud.google.com/iam-admin/iam?organization=320438219353) to understand identity security risk along with our recommendations to remediate it.
- 2. Or, if you have integrated your ITSM tool, a ticket is auto-created for findings with critical or high severity. Leverage the ticket ID to remediate this finding at a future time.
**Estimated Effort**: Medium (2-4 hours) — requires IAM policy review and update
**Automation Potential**: Medium
```bash
...
**Summary**: Remediate SERVICE_AGENT_GRANTED_BASIC_ROLE finding on wanaware-stage

**Next Steps**:
- 1. Review the 'Security insights' column in [IAM](https://console.cloud.google.com/iam-admin/iam?project=358972189709) to understand identity security risk along with our recommendations to remediate it.
- 2. Or, if you have integrated your ITSM tool, a ticket is auto-created for findings with critical or high severity. Leverage the ticket ID to remediate this finding at a future time.
**Estimated Effort**: Medium-High (2 hours - 2 days)
**Automation Potential**: Medium
```bash
