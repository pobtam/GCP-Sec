#!/usr/bin/env python3
# ============================================================
# Finding:   62dafbf75619463381b5e893b72ba26f
...
ZONE     = "UNKNOWN_ZONE"
POD_NAME = "projects/wanaware-security-map-dev/locations/us-central1/repositories/worker-registration-service/dockerImages/worker-registration-service@sha256:e1a958eb820fe1b9a85ed2e02e5ecf21cd76ef1292607646186615df92e3dc85"
