#!/usr/bin/env python3
# ============================================================
# Finding:   ae5f9fe9e73048ebb938820077ed93ba
# Category:  CONTAINER_IMAGE_VULNERABILITY
# Priority:  CRITICAL (risk score 77.76)
# Resource:  projects/wanaware-core-stage/locations/us-central1/repositories/task-scheduler/dockerImages/task-scheduler@sha256:2cc599ce3c99da6978ad04d4402eb83bfb02f1400ff0d2f32e3a19ba39f2d4c3
# Project:   
...
ZONE     = "UNKNOWN_ZONE"
POD_NAME = "projects/wanaware-core-stage/locations/us-central1/repositories/task-scheduler/dockerImages/task-scheduler@sha256:2cc599ce3c99da6978ad04d4402eb83bfb02f1400ff0d2f32e3a19ba39f2d4c3"
