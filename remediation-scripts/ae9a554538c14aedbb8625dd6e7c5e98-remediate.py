#!/usr/bin/env python3
# ============================================================
# Finding:   ae9a554538c14aedbb8625dd6e7c5e98
# Category:  CONTAINER_IMAGE_VULNERABILITY
# Priority:  CRITICAL (risk score 76.08)
# Resource:  projects/wanaware-core-stage/locations/us-central1/repositories/integrator-proxy-service/dockerImages/integrator-proxy-service@sha256:c5a4e5f1a114ad6bd2f5f48118e5819eaea10b1674e65fe9c67532b9ec287d59
# Project:   
...
ZONE     = "UNKNOWN_ZONE"
POD_NAME = "projects/wanaware-core-stage/locations/us-central1/repositories/integrator-proxy-service/dockerImages/integrator-proxy-service@sha256:c5a4e5f1a114ad6bd2f5f48118e5819eaea10b1674e65fe9c67532b9ec287d59"
