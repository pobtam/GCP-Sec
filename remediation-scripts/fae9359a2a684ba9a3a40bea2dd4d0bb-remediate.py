#!/usr/bin/env python3
# ============================================================
# Finding:   fae9359a2a684ba9a3a40bea2dd4d0bb
# Category:  CONTAINER_IMAGE_VULNERABILITY
# Priority:  CRITICAL (risk score 77.76)
# Resource:  projects/wanaware-core-prod/locations/us-central1/repositories/task-scheduler/dockerImages/task-scheduler@sha256:3eeb53645bbdb924efcc1e4450baba5d32527bdb04681547847d4829acf8e5c2
...
ZONE     = "UNKNOWN_ZONE"
POD_NAME = "projects/wanaware-core-prod/locations/us-central1/repositories/task-scheduler/dockerImages/task-scheduler@sha256:3eeb53645bbdb924efcc1e4450baba5d32527bdb04681547847d4829acf8e5c2"
