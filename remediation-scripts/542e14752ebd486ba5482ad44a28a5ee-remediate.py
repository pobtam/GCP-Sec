#!/usr/bin/env python3
# ============================================================
# Finding:   542e14752ebd486ba5482ad44a28a5ee
# Category:  CONTAINER_IMAGE_VULNERABILITY
# Priority:  CRITICAL (risk score 76.08)
# Resource:  projects/wanaware-security-map-dev/locations/us-central1/repositories/worker-proxy-service/dockerImages/worker-proxy-service@sha256:ab6fa30cec3d1d2d6920496cba5b47d233dbe57dd83734e62d21cfeecddaf275
# Project:   
...
ZONE     = "UNKNOWN_ZONE"
POD_NAME = "projects/wanaware-security-map-dev/locations/us-central1/repositories/worker-proxy-service/dockerImages/worker-proxy-service@sha256:ab6fa30cec3d1d2d6920496cba5b47d233dbe57dd83734e62d21cfeecddaf275"
