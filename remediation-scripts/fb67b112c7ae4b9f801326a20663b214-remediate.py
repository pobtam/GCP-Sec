#!/usr/bin/env python3
# ============================================================
# Finding:   fb67b112c7ae4b9f801326a20663b214
# Category:  CONTAINER_IMAGE_VULNERABILITY
# Priority:  CRITICAL (risk score 94.80)
# Resource:  projects/wanaware-core-stage/locations/us-central1/repositories/fleet-manager/dockerImages/fleet-manager@sha256:35e6bb79991e225cd64cf386515ddcbf17dfa89f05b57285ee142d27656efff9
# Project:   
...
ZONE     = "UNKNOWN_ZONE"
POD_NAME = "projects/wanaware-core-stage/locations/us-central1/repositories/fleet-manager/dockerImages/fleet-manager@sha256:35e6bb79991e225cd64cf386515ddcbf17dfa89f05b57285ee142d27656efff9"
