#!/usr/bin/env python3
# ============================================================
# Finding:   93891c9dacaf428497366d43effb15af
# Category:  CONTAINER_IMAGE_VULNERABILITY
# Priority:  CRITICAL (risk score 76.08)
# Resource:  projects/wanaware-core-stage/locations/us-central1/repositories/user-authentication-service/dockerImages/user-authentication-service@sha256:39126ac7c64af9bb83f4c00ce9289072ea7d35d1d44cc8eee0254498567184b4
# Project:   
...
ZONE     = "UNKNOWN_ZONE"
POD_NAME = "projects/wanaware-core-stage/locations/us-central1/repositories/user-authentication-service/dockerImages/user-authentication-service@sha256:39126ac7c64af9bb83f4c00ce9289072ea7d35d1d44cc8eee0254498567184b4"
