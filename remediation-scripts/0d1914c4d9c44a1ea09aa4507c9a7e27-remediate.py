#!/usr/bin/env python3
# ============================================================
# Finding:   0d1914c4d9c44a1ea09aa4507c9a7e27
# Category:  CONTAINER_IMAGE_VULNERABILITY
# Priority:  CRITICAL (risk score 77.76)
# Resource:  projects/wanaware-security-map-dev/locations/us-central1/repositories/worker-management-service/dockerImages/worker-management-service@sha256:0c0a52987a31ce08257eff70d641d676d95bb714a72a5353adb75a694a11f307
# Project:   
...
ZONE     = "UNKNOWN_ZONE"
POD_NAME = "projects/wanaware-security-map-dev/locations/us-central1/repositories/worker-management-service/dockerImages/worker-management-service@sha256:0c0a52987a31ce08257eff70d641d676d95bb714a72a5353adb75a694a11f307"
