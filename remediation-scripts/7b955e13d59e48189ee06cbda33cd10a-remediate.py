#!/usr/bin/env python3
# ============================================================
# Finding:   7b955e13d59e48189ee06cbda33cd10a
# Category:  CONTAINER_IMAGE_VULNERABILITY
# Priority:  CRITICAL (risk score 77.76)
# Resource:  projects/wanaware-security-map-dev/locations/us-central1/repositories/aws-integrator/dockerImages/aws-integrator@sha256:5e5f5b7733502928793c176910c1ded71865990e2e963aee1a6f9bb7df039d80
# Project:   62518548529
...
ZONE     = "UNKNOWN_ZONE"
POD_NAME = "projects/wanaware-security-map-dev/locations/us-central1/repositories/aws-integrator/dockerImages/aws-integrator@sha256:5e5f5b7733502928793c176910c1ded71865990e2e963aee1a6f9bb7df039d80"
