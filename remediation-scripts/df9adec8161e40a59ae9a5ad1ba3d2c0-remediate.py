#!/usr/bin/env python3
# ============================================================
# Finding:   df9adec8161e40a59ae9a5ad1ba3d2c0
# Category:  CONTAINER_IMAGE_VULNERABILITY
# Priority:  CRITICAL (risk score 76.08)
# Resource:  projects/wanaware-core-stage/locations/us-central1/repositories/user-authentication-service/dockerImages/user-authentication-service@sha256:19fe791844eb704c14ebc5e8775ef8c73be7a602fdbbed4164523b3903a01b83
# Project:   
...
ZONE     = "UNKNOWN_ZONE"
POD_NAME = "projects/wanaware-core-stage/locations/us-central1/repositories/user-authentication-service/dockerImages/user-authentication-service@sha256:19fe791844eb704c14ebc5e8775ef8c73be7a602fdbbed4164523b3903a01b83"
