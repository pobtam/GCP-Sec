#!/usr/bin/env python3
# ============================================================
# Finding:   8a2a9853f1d244d4925b4134a606212a
# Category:  CONTAINER_IMAGE_VULNERABILITY
# Priority:  CRITICAL (risk score 78.60)
# Resource:  projects/wanaware-core-dev/locations/us-central1/repositories/chisel-with-auth/dockerImages/chisel-with-auth@sha256:dacc631d9c1ecd2c6afa002d62eaeb039ba8295653749f4d73b5b8f453ea1e67
# Project:   866233621206
# CVE:           CVE-2023-45288 (CVSS 7.5)
...
ZONE     = "UNKNOWN_ZONE"
POD_NAME = "projects/wanaware-core-dev/locations/us-central1/repositories/chisel-with-auth/dockerImages/chisel-with-auth@sha256:dacc631d9c1ecd2c6afa002d62eaeb039ba8295653749f4d73b5b8f453ea1e67"
