#!/usr/bin/env python3
# ============================================================
# Finding:   9e9f619910dc4179a893a64f48a3e065
# Category:  CONTAINER_IMAGE_VULNERABILITY
# Priority:  CRITICAL (risk score 77.76)
# Resource:  projects/wanaware-core-stage/locations/us-central1/repositories/user-authentication-service/dockerImages/user-authentication-service@sha256:8e2885a8f1c01deae239d9a9d436e63e3b2899ba3c1b4d3f3da7016a5908119e
...
ZONE     = "UNKNOWN_ZONE"
POD_NAME = "projects/wanaware-core-stage/locations/us-central1/repositories/user-authentication-service/dockerImages/user-authentication-service@sha256:8e2885a8f1c01deae239d9a9d436e63e3b2899ba3c1b4d3f3da7016a5908119e"
