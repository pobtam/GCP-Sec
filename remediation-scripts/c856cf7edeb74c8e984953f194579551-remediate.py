#!/usr/bin/env python3
# ============================================================
# Finding:   c856cf7edeb74c8e984953f194579551
...
ZONE     = "UNKNOWN_ZONE"
POD_NAME = "projects/wanaware-security-map-dev/locations/us-central1/repositories/worker-crawl-result-service/dockerImages/worker-crawl-result-service@sha256:06788174acbb9eb61d310f2782a809dfe2ac5666b188c604cf03e2766469dcda"
