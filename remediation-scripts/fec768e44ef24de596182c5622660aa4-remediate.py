#!/usr/bin/env python3
# ============================================================
# Finding:   fec768e44ef24de596182c5622660aa4
# Category:  CONTAINER_IMAGE_VULNERABILITY
# Priority:  CRITICAL (risk score 77.76)
# Resource:  projects/wanaware-core-dev/locations/us-central1/repositories/subscription-manager/dockerImages/reseller-wholesale-job@sha256:411ef5f5162c1d41434cd6a2df57240e2f3e5257551436f93dbb87bff17c0fd9
...
ZONE     = "UNKNOWN_ZONE"
POD_NAME = "projects/wanaware-core-dev/locations/us-central1/repositories/subscription-manager/dockerImages/reseller-wholesale-job@sha256:411ef5f5162c1d41434cd6a2df57240e2f3e5257551436f93dbb87bff17c0fd9"
