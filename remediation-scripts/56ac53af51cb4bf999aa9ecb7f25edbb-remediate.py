#!/usr/bin/env python3
# ============================================================
# Finding:   56ac53af51cb4bf999aa9ecb7f25edbb
# Category:  CONTAINER_IMAGE_VULNERABILITY
# Priority:  CRITICAL (risk score 76.08)
# Resource:  projects/wanaware-core-stage/locations/us-central1/repositories/notification-manager/dockerImages/notification-manager@sha256:cab9e775f26b536836d5a5bf951d264e382bca781011c938808142231b2e674d
# Project:   
...
ZONE     = "UNKNOWN_ZONE"
POD_NAME = "projects/wanaware-core-stage/locations/us-central1/repositories/notification-manager/dockerImages/notification-manager@sha256:cab9e775f26b536836d5a5bf951d264e382bca781011c938808142231b2e674d"
