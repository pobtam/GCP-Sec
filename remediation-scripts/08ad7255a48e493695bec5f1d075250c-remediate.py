#!/usr/bin/env python3
# ============================================================
# Finding:   08ad7255a48e493695bec5f1d075250c
# Category:  CONTAINER_IMAGE_VULNERABILITY
# Priority:  CRITICAL (risk score 76.08)
# Resource:  projects/wanaware-security-map-dev/locations/us-central1/repositories/user-authentication-service/dockerImages/user-authentication-service@sha256:8bddbbf60c61c4a5e951febbeabbc1298ecb3dcdc2422fe48c63b7a518c28dde
# Project:   62518548529
...
ZONE     = "UNKNOWN_ZONE"
POD_NAME = "projects/wanaware-security-map-dev/locations/us-central1/repositories/user-authentication-service/dockerImages/user-authentication-service@sha256:8bddbbf60c61c4a5e951febbeabbc1298ecb3dcdc2422fe48c63b7a518c28dde"
