#!/usr/bin/env bash
# ============================================================
# Finding:   9860aeefc8cdb3d9203bc4cf6c86c664
# Category:  SERVICE ACCOUNT KEY THAT EXPOSES MANY VALUED RESOURCES
# Priority:  CRITICAL (risk score 75.00)
# Resource:  projects/wanaware-security-map-dev/serviceAccounts/tfdeploy@wanaware-security-map-dev.iam.gserviceaccount.com/keys/6e73adaa2ba7b71de16cc13477750759224aeab9
# Project:   
