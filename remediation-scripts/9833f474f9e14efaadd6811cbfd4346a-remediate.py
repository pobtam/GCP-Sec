#!/usr/bin/env python3
# ============================================================
# Finding:   9833f474f9e14efaadd6811cbfd4346a
# Category:  CONTAINER_IMAGE_VULNERABILITY
# Priority:  CRITICAL (risk score 77.76)
# Resource:  projects/wanaware-core-stage/locations/us-central1/repositories/worker-crawl-result-service/dockerImages/worker-crawl-result-service@sha256:c07261bab7ba60fd3f00e20b16eb37be46bef4e775991ceaefda8988b6ec9dc6
# Project:   
...
ZONE     = "UNKNOWN_ZONE"
POD_NAME = "projects/wanaware-core-stage/locations/us-central1/repositories/worker-crawl-result-service/dockerImages/worker-crawl-result-service@sha256:c07261bab7ba60fd3f00e20b16eb37be46bef4e775991ceaefda8988b6ec9dc6"
