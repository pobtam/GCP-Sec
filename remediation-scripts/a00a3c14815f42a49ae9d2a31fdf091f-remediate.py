#!/usr/bin/env python3
# ============================================================
# Finding:   a00a3c14815f42a49ae9d2a31fdf091f
# Category:  CONTAINER_IMAGE_VULNERABILITY
# Priority:  CRITICAL (risk score 77.76)
# Resource:  projects/wanaware-core-dev/locations/us-central1/repositories/worker-crawl-result-service/dockerImages/worker-crawl-result-service@sha256:0d787c4b144d95c50595ce2eef771c99889f72d312f099da2081f8a563ee2a9b
...
ZONE     = "UNKNOWN_ZONE"
POD_NAME = "projects/wanaware-core-dev/locations/us-central1/repositories/worker-crawl-result-service/dockerImages/worker-crawl-result-service@sha256:0d787c4b144d95c50595ce2eef771c99889f72d312f099da2081f8a563ee2a9b"
