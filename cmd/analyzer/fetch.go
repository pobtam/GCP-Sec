...
func runFetch(args []string) int {
	...
	fs.StringVar(&ff.Output, "output", "report.md", "Output file path")
	fs.StringVar(&ff.Output, "o", "report.md", "Output file path (shorthand)")
	fs.StringVar(&ff.Format, "format", "markdown", "Output format")
	fs.StringVar(&ff.Format, "f", "markdown", "Output format (shorthand)")
